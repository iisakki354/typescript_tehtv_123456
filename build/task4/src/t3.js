...
function createElectronicDevice() {
    ...
    const brand = prompt("Enter brand") /* TODO: Get user input for brand */;
    const model = prompt("Enter model") /* TODO: Get user input for model */;
    // TODO: return object containing brand and model
    return { brand, model };
}
function createBook() {
    // TODO: Prompt user for book details (title and author)
    const title = prompt("") /* TODO: Get user input for title */;
    const author = prompt("") /* TODO: Get user input for author */;
